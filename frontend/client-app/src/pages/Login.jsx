...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      toast.success('Google ile giriş başarılı! %10 indiriminiz aktif.');
      navigate(redirect);
    } catch (error) {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 mt-2">Hesabınıza giriş yapın ve %10 indirim kazanın</p>
          </div>
